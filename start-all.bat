...
echo ============================================================
echo.
echo This script starts all services in DEVELOPMENT mode with hot-reload.
...
echo User Frontend:   http://localhost:5173  (hot-reload)
echo Admin Frontend:  http://localhost:3001  (hot-reload)
echo.
