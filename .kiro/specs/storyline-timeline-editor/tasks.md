...
- [ ] 1. Extend Backend Data Models and Database Schema
  - [ ] 1.1 Update Storyline SQLAlchemy model with new fields (synopsis, status, display_order, video resolution, cover paths)
  ...
  - [ ] 1.2 Create Transition SQLAlchemy model and table
  ...
  - [ ] 1.6 Write property tests for data model validation
...
- [ ] 2. Implement Storyline Service Extensions
  - [ ] 2.1 Implement storyline CRUD with new fields
  ...
  - [ ] 2.2 Write property test for cascade deletion
    - **Property 4: Cascade Deletion**
    - **Validates: Requirements 1.4**
  - [ ] 2.3 Implement publish/unpublish functionality
    - Validate video exists before publishing
    - Update status field
    - _Requirements: 1.2, 10.1, 10.2_
  - [ ] 2.4 Write property test for draft status without video
    - **Property 2: Draft Status Without Video**
    - **Validates: Requirements 1.2**
  - [ ] 2.5 Implement storyline ordering
    - Update display_order field
    - Return storylines sorted by display_order
    - _Requirements: 10.3_
  - [ ] 2.6 Write property test for storyline order persistence
...
- [ ] 5. Implement Image Processing Service
  ...
  - [ ] 5.3 Write property test for cover image size generation
    - **Property 23: Cover Image Size Generation**
    - **Validates: Requirements 9.3**
  - [ ] 5.4 Implement cover image endpoints
    - Upload cover image
    - Capture video frame as cover
    - Delete cover (revert to default)
    - _Requirements: 9.1, 9.2, 9.4_

- [ ] 6. Implement Segment Management API
  - [ ] 6.1 Update segment service with timeline fields
    - Handle start_time, duration, animation configs
    - Validate segment non-overlap
    - Validate total duration <= video duration
    - _Requirements: 4.1, 4.2, 4.6_
  - [ ] 6.2 Write property test for segment non-overlap
    - **Property 8: Segment Non-Overlap**
    - **Validates: Requirements 4.2**
  - [ ] 6.3 Write property test for total duration validation
    - **Property 11: Total Duration Validation**
    - **Validates: Requirements 4.6**
  - [ ] 6.4 Implement segment re-indexing on deletion
    - Remove segment and update indices
    - Ensure sequential indices from 0
    - _Requirements: 4.5_
  - [ ] 6.5 Write property test for segment index continuity
    - **Property 10: Segment Index Continuity**
    - **Validates: Requirements 4.5**
  - [ ] 6.6 Implement guidance image endpoints
...
- [ ] 12. Create Timeline Editor Frontend - Core Components
  - [ ] 12.1 Create TimelineEditorContext for state management
    - Manage playhead, zoom, selection, playback state
    - Provide actions for state updates
    - _Requirements: 3.1, 3.2_
  - [ ] 12.2 Create VideoPreview component
